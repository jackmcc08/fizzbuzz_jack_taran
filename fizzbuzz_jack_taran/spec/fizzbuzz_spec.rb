...
describe 'fizzbuzz' do
  it 'returns "fizz" when passed a multiple of 3' do
    ...
    expect(333.fizzbuzz).to eq 'Fizz'
  end
end
...
describe 'fizzbuzz' do
  it 'returns "nil" when passed anything which isn\'t an integer' do
    ...
    # expect("string".fizzbuzz).to eq nil
    # expect(1.5.fizzbuzz).to eq nil
    # expect(:symbol.fizzbuzz).to eq nil
  end
end
...
describe 'fizzbuzz' do
  it 'returns "fizzbuzz" when passed a multiple of 3 and 5' do
    ...
    expect(1500.fizzbuzz).to eq 'FizzBuzz'
